...
<?php $itms =  $all_lan['cate']; ?><?php  echo new_list_select(array('field'=>'cate','items'=>$itms,'fname'=>'渠道分类','defaultvalue'=>input('get.cate'),'requestFnName'=>'cate')); ?>
...
<th><font style='<?php echo $color[$v['cate']];  ?>'><?php  echo $all_lan['cate'][$v['cate']]; ?></font></th>
