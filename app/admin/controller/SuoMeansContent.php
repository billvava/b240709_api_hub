...
* @menu true
*/
class SuoMeansContent extends BCOM{
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new \app\admin\model\SuoMeansContent();
        ...
        $ziliaobiaoqian = (new \app\admin\model\SuoMeansTag())->getOption();
        View::assign('ziliaobiaoqian', $ziliaobiaoqian);
