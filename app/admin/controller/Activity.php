    ...
    private function item() {
        ...
        if ($this->request->isPost()) {
            ...
            if ($in[$this->pk]) {
                ...
                $r = $this->model->where($this->pk,$in[$this->pk])->update(['winning_numbers' => $in['winning_numbers']]);
                Db::name('activity_jingcai') -> where('activity_id',$in[$this->pk]) -> update(['winning_numbers' => $in['winning_numbers']]);
                $r = $in[$this->pk];
            } else {
