...
class SystemLog extends BCOM{
    ...
    */
    public function index() {
        ...
        $date_time = explode(' - ', $in['create_time']);
        $start_datetime = $date_time[0];
        $end_datetime = $date_time[1];
        if ($start_datetime && $end_datetime) {
            $where[] = array('create_time', 'between', array($start_datetime, $end_datetime . ' 23:59:59'));
        } elseif ($start_datetime) {
            $where[] = array('create_time', '>', $start_datetime);
        } elseif ($end_datetime) {
            $where[] = array('create_time', '<', $end_datetime . ' 23:59:59');
        }
