...
<!--<th>--><?php // echo_img($v['thumb']); ?><!--</th>-->
                    ...
                    <th>
                        <?php if($v['state'] == 0){ ?>
                            <a  class="pear-btn pear-btn-primary pear-btn-sm" href="javascript://" onclick="del('<?php echo url('chuli',array($pk=>$v[$pk],'state'=>1) ); ?>')">同意</a>
                            <a  class="pear-btn pear-btn-primary pear-btn-sm" href="javascript://"  onclick="del('<?php echo url('chuli',array($pk=>$v[$pk],'state'=>2) ); ?>')">拒绝</a>
                        <?php } ?>
                        <?php if($is_edit==1){ ?>
