...
<?php $itms =  $all_lan['status']; ?><?php  echo new_list_select(array('field'=>'status','items'=>$itms,'fname'=>'状态','defaultvalue'=>input('get.status'),'requestFnName'=>'status','callfname'=>'cate_id')); ?>
...
<th><?php echo $v['name']; ?></th>
                    <th><?php echo $all_lan['cate_id'][$v['cate_id']]; ?></th>
