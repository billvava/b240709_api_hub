...
<!--  【thumb】 end  !-->
<!--  【lat】 start  !-->
<?php echo form_input(array('field'=>'lat','fname'=>'纬度','defaultvalue'=>$info?$info['lat']:'','col'=>4)); ?>
<!--  【lat】 end  !-->
<!--  【lng】 start  !-->
<?php echo form_input(array('field'=>'lng','fname'=>'经度','defaultvalue'=>$info?$info['lng']:'','col'=>4)); ?>
<!--  【lng】 end  !-->
<!--  【address】 start  !-->
