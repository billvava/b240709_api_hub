...
<div class='layui-inline' >
	...
	<div class='layui-input-inline'>
		<input type='text' name='username'  value='<?php echo input('get.username'); ?>' class='layui-input'>
...
<?php echo list_rangedate(array('field'=>'create_time','fname'=>'create_time','defaultvalue'=>input('get.create_time'))); ?>
