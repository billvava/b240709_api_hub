...
class Driver
{
     ...
     * @return mixed
     */
    public function setUpload($name = 'file')
    {
        return $this->engine->setUpload($name);
    }
    ...
    {
        return $this->engine->setBase64($body);
    }
    ...
    {
        return $this->engine->getFielUrl($obj,$map);
    }
