...
<?php if($searchArr['name']){ ?><input type='text' name='name' value='<?php echo input('get.name'); ?>'  placeholder='名称'  class='layui-input'><?php } ?>
<?php if($searchArr['start']){ ?><input type='text' name='start' value='<?php echo input('get.start'); ?>'  placeholder='开始'  class='layui-input'><?php } ?>
<?php if($searchArr['end']){ ?><input type='text' name='end' value='<?php echo input('get.end'); ?>'  placeholder='结束'  class='layui-input'><?php } ?>
