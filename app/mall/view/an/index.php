...
<div class='x-body' >
    ...
    <div class="layui-row mt10">
        <form class="layui-form layui-col-md12 x-so" id="index_form" action=""  method="get">
            <?php if($searchArr['title']){ ?><input type='text' name='title' value='<?php echo input('get.title'); ?>'  placeholder='公告'  class='layui-input'><?php } ?>
...
<?php if($searchArr['time']){ ?><?php echo list_rangedate(array('field'=>'time','fname'=>'发布时间','defaultvalue'=>input('get.time'))); ?><?php } ?>
