...
* @menu true
*/
class GoodsComment extends BCOM{
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new \app\mall\model\MallGoodsComment();
        ...
        View::assign('comment_type', lang('comment_type'));
        View::assign('comment_rank', lang('comment_rank'));
    }
    ...
    */
    public function index() {
        ...
        $data['list'] = Db::name($this->db_name)
                ->alias('a')
                ->leftJoin('mall_goods b','a.goods_id=b.goods_id')
