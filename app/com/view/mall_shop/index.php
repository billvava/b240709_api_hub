...
<?php } ?>
<?php if($searchArr['name']){ ?><input type='text' name='name' value='<?php echo input('get.name'); ?>'  placeholder='名称'  class='layui-input'>
<?php } ?>
<?php if($searchArr['address']){ ?><input type='text' name='address' value='<?php echo input('get.address'); ?>'  placeholder='地址'  class='layui-input'>
<?php } ?>
<?php if($searchArr['status']){ ?><?php $itms =  $all_lan['status']; ?><?php  echo list_select(array('field'=>'status','items'=>$itms,'fname'=>'状态','defaultvalue'=>input('get.status'),'requestFnName'=>'status')); ?><?php } ?>
...
<th><?php echo $v['address']; ?></th><th><?php echo $v['tel']; ?></th>
<th><?php echo $v['linkman']; ?></th>
<th><?php echo $v['yy_time']; ?></th>
