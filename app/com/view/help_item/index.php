...
<?php } ?>
<?php if($searchArr['token']){ ?><input type='text' name='token' value='<?php echo input('get.token'); ?>'  placeholder='标识'  class='layui-input'>
<?php } ?>
<?php if($searchArr['name']){ ?><input type='text' name='name' value='<?php echo input('get.name'); ?>'  placeholder='标题'  class='layui-input'>
<?php } ?>

<?php if($searchArr['status']){ ?><?php $itms =  $all_lan['status']; ?>
    <?php  echo list_select(array('field'=>'status','items'=>$itms,'fname'=>'状态','defaultvalue'=>input('get.status'),'requestFnName'=>'status')); ?>
        
 <?php } ?>

<?php if($searchArr['cate_id']){ ?>

    <?php  echo list_select(array('field'=>'cate_id','items'=>$cate,'fname'=>'分类','defaultvalue'=>input('get.cate_id'),'requestFnName'=>'')); ?>
