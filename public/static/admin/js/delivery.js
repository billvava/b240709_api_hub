    ...
    Delivery.prototype = {
        ...
        appendRulesTr: function (regionStr, checkedIds) {
            var $html = $(
                ...
                '   </p>' +
                '   <input type="hidden" class="layui-input w100"  name="delivery[rule][region][]" value="' + checkedIds + '">' +
                '</td>' +
                '<td>' +
                '   <input type="number"  class="layui-input w100"  name="delivery[rule][first][]" value="1" required>' +
                '</td>' +
                '<td>' +
                '   <input type="number"  class="layui-input w100"  name="delivery[rule][first_fee][]" value="0.00" required>' +
                '</td>' +
                '<td>' +
                '   <input type="number"  class="layui-input w100"  name="delivery[rule][additional][]" value="0">' +
                '</td>' +
                '<td>' +
                '   <input type="number"  class="layui-input w100"  name="delivery[rule][additional_fee][]" value="0.00">' +
                '</td>' +
                '</tr>'
            );
