...
class WxPayApi {
    ...
    public function __construct() {
        $this->SSLCERT_PATH = C('SSLCERT_PATH')?C('SSLCERT_PATH'):getcwd() . "/../tool/WxPayPubHelper/cacert/apiclient_cert.pem";
        $this->SSLKEY_PATH = C('SSLKEY_PATH')?C('SSLKEY_PATH'): getcwd() . "/../tool/WxPayPubHelper/cacert/apiclient_key.pem";
        $this->APPID = C('appid');
        $this->MCHID = C('wxshopid');
...
//        p($xml);
    ...
    private  function postXmlCurl($xml, $url, $useCert = false, $second = 30) {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, "wxpay sdk php v3.0 " . $this->MCHID);
        //设置header
